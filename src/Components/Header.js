        ...
        <Stack>
            <Flex direction='column'alignSelf="flex-start">
                <Box align='center'>
                    ...
                    <Text fontSize={{ base: '12px', md: '24px', lg: '28px' }} color={isDark ? "gray.400" : "gray.500"}>Computer engineer and programmer</Text>
                </Box>
                <Center>
                    <Circle size='305px' bg={isDark ? "gray.400" : "gray.500"} mt='12' >
